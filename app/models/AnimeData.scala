...
case class AnimeData(mal_id: Int, title: String, title_english: Option[String], title_synonyms: Seq[String], `type`: String,
                     episodes: Option[Int], status: String, aired: AirDates, duration: Option[String], rating: Option[String],
